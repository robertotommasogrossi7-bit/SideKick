...
import { BadgeImg } from './BadgesModal'
...
export function HabitCard({ habit, onAddOccurrence, onEdit, onDelete, onViewBadges }: Props) {
  const latestBadges = habit.earnedBadges.slice(0, 3)
    ...
    <div className="habit-card">
      ...
      <div className="streak-info">
        <div className="streak-item">
          ...
          <div className="streak-value">{calculateCurrentStreak(habit)}</div>
        </div>
        <div className="streak-item">
          <div className="streak-label">Longest Streak</div>
          <div className="streak-value">{calculateLongestStreak(habit)}</div>
        </div>
        <div className="streak-item">
