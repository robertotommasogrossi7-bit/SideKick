...
## Colpo d'occhio
- **18.2M token di output** (+ **29.1M** da agenti cloud) su **64 sessioni**
  in **12 progetti**, dal 2026-05 a oggi. 11k messaggi in totale.
- La **cache** ha riletto 3549.3M token (≈187× i token vivi): riprendere una chat
...
| [SideKick](per-progetto/sidekick.md) | 2026-06-03 → 2026-07-25 | 12 | 2.1M | 116k | 251.0M |
