...
## Colpo d'occhio
- **18.2M token di output** (+ **30.2M** da agenti cloud) su **65 sessioni**
  in **12 progetti**, dal 2026-05 a oggi. 11k messaggi in totale.
- La **cache** ha riletto 3557.5M token (≈187× i token vivi): riprendere una chat
...
| [SideKick](per-progetto/sidekick.md) | 2026-06-03 → 2026-07-25 | 12 | 2.1M | 117k | 258.1M |
...
| [Studio](per-progetto/studio.md) | 2026-07-20 → 2026-07-25 | 5 | 893k | 3k | 354.8M |
