...
(aggiornare il glossario dai materiali di studio AWS, esperimenti sul metodo, ecc.).
...
- `versione-italiano/glossario/INDICE.md` — i termini che Roberto sta imparando (dove finiscono i termini nuovi).
