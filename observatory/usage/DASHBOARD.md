...
## At a glance
- **18.4M output tokens** (+ **31.2M** from cloud agents) across **65 sessions**
  in **12 projects**, from 2026-05 to today. 11k messages in total.
- The **cache** re-read 3625.5M tokens (≈189× the live tokens): resuming a chat
  on a warm cache is what keeps the plan sustainable — restarting from scratch throws it away.
- **API cost-equivalent: $3.7k**, computed at the prices verified on 2026-07-25 in `prices.csv`. **This is NOT what is actually billed** on the Max/Pro plan
...
- **Where the API-equivalent goes** (local chats): cache read $1.9k (53%) + cache write $1.2k (34%) + output $497.19 (14%) + input $3.95 — the cache IS the
...
- **Agent workflows measured from local transcripts: $174.20 across 7 of 17 registered runs** — priced message-by-message from the per-agent transcripts this machine kept;
...
| 8 | (redacted) — progetto-15 | chat | 2026-05-29 | 1.5M | $479.69 |
...
| [SideKick](per-project/sidekick.md) | 2026-06-03 → 2026-07-26 | 12 | 2.2M | 117k | 306.5M | $429.24 |
...
| [Studio](per-project/studio.md) | 2026-07-20 → 2026-07-26 | 5 | 998k | 3k | 374.5M | $447.84 |
