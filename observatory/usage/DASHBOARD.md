...
- The **cache** re-read 3686.4M tokens (≈190× the live tokens): resuming a chat
...
- **Where the API-equivalent goes** (local chats): cache read $2.0k (53%) + cache write $1.3k (34%) + output $509.13 (13%) + input $4.03 — the cache IS the
...
- **Agent workflows measured from local transcripts: $174.20 across 7 of 19 registered runs** — priced message-by-message from the per-agent transcripts this machine kept;
...
| 2 | Fabbrica libri run 1 (Effective Python): 628 domande nuove con QC totale (Opus fuso + ombra 8% Sonnet + ricontrolli) + bonifica files su 355 vecchie + 194 rotazioni posizionali + glossario post-update — Studio | cloud agents | 2026-07-26 | 9.9M | — |
...
| 7 | Bridge F1: auto-import into 2 apps + 167 questions generated from weather_report (12 batches, QC 3x Opus, Haiku shadow) — Studio | cloud agents | 2026-07-20 | 1.5M | — |
...
| [SideKick](per-project/sidekick.md) | 2026-06-03 → 2026-07-26 | 12 | 2.3M | 117k | 310.1M | $442.26 |
