...
> Generated by `observatory/usage.mjs` on 2026-07-17. **Do not edit by
...
## At a glance
- **15.9M output tokens** (+ **4.8M** from cloud agents) across **55 sessions**
  in **11 projects**, from 2026-05 to today. 9k messages in total.
- The **cache** re-read 2840.1M tokens (≈170× the live tokens): resuming a chat
...
| [SideKick](per-project/sidekick.md) | 2026-06-03 → 2026-07-17 | 11 | 1.8M | 116k | 185.1M |
...
|---|---|---|---|---|
| opus-4-8 | 5k | 626k | 10.9M | 1923.9M |
| opus-4-7 | 1k | 15k | 2.2M | 259.4M |
| sonnet-4-6 | 2k | 38k | 1.5M | 137.6M |
| fable-5 | 434 | 43k | 865k | 122.4M |
