...
> Generated by `observatory/usage.mjs` on 2026-07-26. **Do not edit by
...
## At a glance
- **18.7M output tokens** (+ **41.6M** from cloud agents) across **66 sessions**
  in **12 projects**, from 2026-05 to today. 11k messages in total.
- The **cache** re-read 3688.6M tokens (≈190× the live tokens): resuming a chat
  on a warm cache is what keeps the plan sustainable — restarting from scratch throws it away.
- **API cost-equivalent: $3.8k**, computed at the prices verified on 2026-07-25 in `prices.csv`. **This is NOT what is actually billed** on the Max/Pro plan
...
- **Where the API-equivalent goes** (local chats): cache read $2.0k (53%) + cache write $1.3k (34%) + output $509.55 (13%) + input $4.03 — the cache IS the
...
- **Agent workflows measured from local transcripts: $321.07 across 10 of 19 registered runs** — priced message-by-message from the per-agent transcripts this machine kept;
...
| 2 | Fabbrica libri run 1 (Effective Python): 628 domande nuove con QC totale (Opus fuso + ombra 8% Sonnet + ricontrolli) + bonifica files su 355 vecchie + 194 rotazioni posizionali + glossario post-update — Studio | cloud agents | 2026-07-26 | 9.9M | $131.50 |
...
| [SideKick](per-project/sidekick.md) | 2026-06-03 → 2026-07-26 | 12 | 2.3M | 117k | 312.3M | $444.99 |
| [Libri-Organizzazione](per-project/libri-organizzazione.md) | 2026-05-07 → 2026-05-31 | 2 | 1.3M | 11k | 121.4M | $138.83 |
| [Studio](per-project/studio.md) | 2026-07-20 → 2026-07-26 | 6 | 1.2M | 11k | 431.8M | $536.31 |
...
*(showing the last 30 of 59 recorded days; the full series is in `daily.csv`)*
