...
| "Censura progetto-15 cosmetica, racconti i bug di terzi" (Claude) | **Parzialmente**: è un progetto DI Roberto (non di terzi), non ancora pubblico | ⏳ Da decidere con Roberto: togliere i dettagli dei finding censurati dal materiale pubblico |
| "Regola Spotify = cargo-cult da principiante in pubblico" (entrambi, toni diversi) | Opinione, non fatto | ⏳ Da decidere: resta nel metodo (utile a Roberto), ma il README non la mette in vetrina |
